...
if [ ! -d "./logs/LongForecasting/Norm/CFWCFIN" ]; then
    mkdir ./logs/LongForecasting/Norm/CFWCFIN
fi
# seq_len=700
model_name=CFWCFIN
...
do
    ...
    --itr 1   > logs/LongForecasting/Norm/CFWCFIN/$data_name'_'$seq_len'_'$pred_len.logs
