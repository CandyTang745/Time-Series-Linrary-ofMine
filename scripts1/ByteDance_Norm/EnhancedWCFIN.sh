...
if [ ! -d "./logs/LongForecasting/Norm/EnhancedWCFIN" ]; then
    mkdir ./logs/LongForecasting/Norm/EnhancedWCFIN
fi
# seq_len=700
model_name=EnhancedWCFIN
...
do
    ...
    --itr 1   > logs/LongForecasting/Norm/EnhancedWCFIN/$data_name'_'$seq_len'_'$pred_len.logs
