...
if [ ! -d "./logs/LongForecasting/Norm/FreTS" ]; then
    mkdir ./logs/LongForecasting/Norm/FreTS
fi
# seq_len=700
model_name=FreTS
...
do
    ...
    --c_out $enc_in \
    --des 'Exp' \
    --itr 1  > logs/LongForecasting/Norm/FreTS/$data_name'_'$seq_len'_'$pred_len.logs
