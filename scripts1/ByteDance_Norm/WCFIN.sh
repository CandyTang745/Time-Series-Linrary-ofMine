...
if [ ! -d "./logs/LongForecasting/Norm/WCFIN" ]; then
    mkdir ./logs/LongForecasting/Norm/WCFIN
fi
# seq_len=700
model_name=WCFIN
...
do
    ...
    --itr 1   > logs/LongForecasting/Norm/WCFIN/$data_name'_'$seq_len'_'$pred_len.logs
